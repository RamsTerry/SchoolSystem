...
@ComponentScan(basePackages = "sars.gov.za.schoolManagement.service")
...
public class TestDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("sars.gov.za.schoolManagement.domain");
